...
class Person constructor(_name: String = "Jesus"){            // Конструктор имеет параметр _name, который представляет тип String
    ...
    // class collections.Person constructor(_name: String)
    ...
    // class collections.Person(val name: String, val age: Int) - Первичный конструктор сразу с описанием полей-свойств
